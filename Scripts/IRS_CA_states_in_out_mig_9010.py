...
for folder in [inmig_91_11, outmig_91_11]:
    ...
    for file in folder:
        ...
        if int(num) > 20:
            yr = int('19' + num) - 1  # Subtracting 1 since data covers *fiscal* year (i.e. 2010-2011 file represents 2010 migration)
        else:
            yr = int('20' + num) - 1
...
master_df.to_csv('IRS_CA_states_inmig_9010.csv', index=False)