...
# Cleaning Census State Mig Tables (Source: https://www.census.gov/content/census/en/data/tables/time-series/demo/geographic-mobility/state-to-state-migration.html)
...
in_out_df['Tot_Mig'] = in_out_df.Inmig + in_out_df.Outmig
in_out_df.to_csv('Census_1yr_CA_mig_states_0518.csv', index=False)

ca = in_out_df[in_out_df.State == 'California'].drop('State', axis=1)
ca = ca[['Year', 'Inmig', 'Outmig', 'Net_Mig', 'Tot_Mig']]
ca.to_csv('Census_CA_mig_0518.csv', index=False)